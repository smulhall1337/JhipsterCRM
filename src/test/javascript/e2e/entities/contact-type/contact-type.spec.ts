...
describe('ContactType e2e test', () => {
    ...
    it('should load ContactTypes', async () => {
        ...
        expect(await contactTypeComponentsPage.getTitle()).to.eq('cwcrm2App.contactType.home.title');
    });
    ...
    it('should load create ContactType page', async () => {
        ...
        expect(await contactTypeUpdatePage.getPageTitle()).to.eq('cwcrm2App.contactType.home.createOrEditLabel');
    ...
    it('should create and save ContactTypes', async () => {
        ...
        expect(await contactTypeUpdatePage.getNameInput()).to.eq('name');
    ...
    it('should delete last ContactType', async () => {
        ...
        expect(await contactTypeDeleteDialog.getDialogTitle()).to.eq('cwcrm2App.contactType.delete.question');
